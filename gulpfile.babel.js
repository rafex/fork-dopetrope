...
const paths = {
    ...
    'external_source/jquery.dropotron/jquery.dropotron.js',
    'external_source/responsive-tools/browser.js',
    'external_source/responsive-tools/breakpoints.js',
    'external_source/html5up-dopetrope/html5up-dopetrope-util.js'],
    jquery: 'node_modules/jquery/dist/jquery.js',
    jquery_validate: 'node_modules/jquery-validation/dist/jquery.validate.js',
    jquery_dropotron: 'external_source/jquery.dropotron/jquery.dropotron.js',
    browser: 'external_source/responsive-tools/browser.js',
    breakpoints: 'external_source/responsive-tools/breakpoints.js',
    html5_dopetrope_util: 'external_source/html5up-dopetrope/html5up-dopetrope-util.js'
};
